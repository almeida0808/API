...
usersRouter.put("/:id" , usersController.update); // toda vez que colocarmos um id como parametro automaticamente ele entende que estamos querendo atualizar o usuário
